        ...
        Column(
            ...
            Row(
                ...
                Icon(
                    ...
                    modifier = Modifier
                        .size(40.dp)
                        .background(Color(0xFF006B2C), RoundedCornerShape(10.dp))
                        .padding(8.dp)
                )
                Spacer(modifier = Modifier.width(8.dp))
                Text(text = "PharmaX", fontSize = 24.sp, fontWeight = FontWeight.Bold, color = Color(0xFF006B2C))
            }
            ...
            Column(
                ...
                ElevatedButton(
                    ...
                    colors = ButtonDefaults.elevatedButtonColors(
                        containerColor = Color(0xFF006B2C),
            ...
            Column(
                ...
                Text(
                    text = "Your medical data and credentials are encrypted according to HIPAA healthcare standards.",
                    fontSize = 12.sp,
